...
if(!empty($_GET['id']) && $_GET['id']) {
	echo $_GET['id'];
	$lap_harian_values = $talikuat->getlap_harian($_GET['id']);		
}	
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Approval Laporan Harian</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
	...
	<form action="../fungsi/edit/edit.php?ppk=edit" method="POST" enctype="multipart/form-data" > 
     ...
     <div class="card card-danger">
			...
			<div class="card-body">			
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="diajukan_tgl" name="diajukan_tgl" value="<?php echo $lap_harian_values['no_request'];?>" required="required">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="lokasi_sta" name="lokasi_sta" value="<?php echo $lap_harian_values['segmen_jalan'];?>" required="required">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="jenis_pekerjaan" name="jenis_pekerjaan" value="<?php echo $lap_harian_values['nmp'];?>" required="required">
                    </div>
                  </div>
				 ...
				 <div class="form-group row">
                    ...
                    <div class="col-sm-10">   
						<div class="input-group mb-3">
						    <input type="text" class="form-control" id="perkiraan_volume" name="perkiraan_volume" value="<?php echo $lap_harian_values['volume'];?>" required="required">
							<input id="satuan" value="<?php echo $lap_harian_values['satuan'];?>" type="hidden" class="form-control" name="satuan">
						  <div class="input-group-append">
						  
							<span class="input-group-text"><?php echo $lap_harian_values['satuan'];?></span>
						  </div>
						</div>
					</div>
                  </div>
			     ...
			     <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Sketsa/SoftDrawing/Dokumentasi Penyedia Jasa</label>
                    <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" id="catatan" name="catatan"><?php echo $lap_harian_values['catatan_konsultan'];?></textarea>
                        </div>
                      </div>				  

			     <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Sketsa/SoftDrawing/Dokumentasi Konsultan</label>
                    <div class="col-sm-10">
                     
					  <img src="../lampiran/lh/<?php echo $lap_harian_values['foto_konsultan'];?>"  alt="#" style="width:200px;border:4px solid #ddd;"/>
                    </div>
                  </div>
     ...
     <div class="card card-primary">
			...
			<div class="card-body">	
			     ...
			     <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Sketsa/SoftDrawing/Dokumentasi</label>
                    <div class="col-sm-10">
                      <input type="file" class="form-control" id="dokumentasi" name="dokumentasi" required="required">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="radio" name="approval" value="1" id="myradio">DISETUJUI
					  <input type="radio" name="approval" value="2" id="myradio">DITOLAK
                    </div>
                  </div>
			  
                      <div class="form-group row">
                        <label for="inputExperience" class="col-sm-2 col-form-label">Catatan</label>
                        <div class="col-sm-10">
      ...
      <!-- /.card -->
	            ...
	            <div class="card-footer">
					...
					<input type="hidden" value="<?php echo $lap_harian_values['no_trans']; ?>" class="form-control" name="id" id="id">
