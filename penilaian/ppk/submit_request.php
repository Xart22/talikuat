...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Approval Request Pekerjaan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
	...
	<form action="../fungsi/edit/edit.php?ppk1=edit" method="POST" enctype="multipart/form-data" > 
			...
			<div class="card-body">			
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" id="catatan_k" name="catatan_k" ><?php echo $lap_req['catatan_konsultan'];?></textarea>
                        </div>
                      </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
					  ...
					  <img src="../lampiran/req/<?php echo $lap_req['foto_konsultan'];?>"  alt="#" style="width:200px;border:4px solid #ddd;"/>
                    </div>
                  </div>	
