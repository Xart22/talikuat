					...
					<div class="col-lg-12 main-chart">
						...
						-->
							...
							<table class="table table-bordered table-striped" id="example1">
								...
								<tbody>
								<?php 
									$hasil = $talikuat -> list_laporan_harian_ppk();
									$no=1;
									foreach($hasil as $isi){
								?>
									<tr>
										...
										<td width=15% align="center">
											...
											<a href="submit_laporan.php?id=<?php echo $isi['no_trans'];?>" title="Approval" class="<?php echo $isi['aksi3'];?>" ><span class="far fa-paper-plane"></span></a>										
