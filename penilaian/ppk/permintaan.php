  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="../assets/img/jabar.png" alt="" class="brand-image img-circle elevation-3"
           style="opacity: .8">
	  <span class="brand-text font-weight-light">pepen jangar</span>   
					...
					<div class="col-lg-12 main-chart">
						...
						-->
							...
							<table class="table table-bordered table-striped" id="example1">
								...
								<tbody>
								<?php 
									$hasil = $talikuat -> list_permintaan_ppk();
									$no=1;
									foreach($hasil as $isi){
								?>
									<tr>
										<td><?php echo $no;?></td>
										<td><?php echo 'FRM-01/SOP/DBMPR-'.$isi['id'];?><br/>
										<?php echo $isi['diajukan_tgl'];?></td>
										<td><?php echo $isi['nama_kegiatan'];?></td>
										
										<td><?php echo $isi['lokasi_sta'];?><br/>
										<?php echo $isi['jenis_pekerjaan'];?><br/>
										<?php echo $isi['volume'];?> (<?php echo $isi['satuan'];?>)</td>
										<td><img src="../lampiran/req/<?php echo $isi['sketsa'];?>"  alt="#" style="width:150px;border:4px solid #ddd;"/></td>
										<td><?php echo $isi['catatan_konsultan'];?><br/>
										<img src="../lampiran/req/<?php echo $isi['foto_konsultan'];?>"  alt="#" style="width:150px;border:4px solid #ddd;"/><br/>
										<a href="../ViewerJS/#../lampiran/req/<?php echo $isi['app_konsultan'];?>" alt="#" target="_blank">File Cheklist</a>
										
										</td>
										<td><?php echo $isi['catatan_ppk'];?><br/>
										<img src="../lampiran/req/<?php echo $isi['foto_ppk'];?>"  alt="#" style="width:150px;border:4px solid #ddd;"/></td>
										<td><?php echo $isi['gk1'];?><br/> 
										<?php echo $isi['gk2'];?><br/> 
										<?php echo $isi['gp1'];?>
										</td>
										<td>
											
											<a href="submit_request.php?req_id=<?php echo $isi['id'];?>" title="Approval" class="<?php echo $isi['aksi3'];?>" ><span class="far fa-paper-plane"></span></a>										
