			  ...
			  <form action="" id="invoice-form" method="post" class="form-horizontal" role="form" novalidate="" enctype="multipart/form-data" > 
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="tgl_kontrak" name="tgl_kontrak_kontrak" required="required">
                    </div>
                  </div>				  
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
						<select name="nama_se" id="nama_se" class="select2 form-control" data-live-search="true" >
																	<option value="0">Pilih Nama SE </option>
																	<?php
																		foreach($itemPengguna as $se)
																		{
																	?>
																		<option value="<?php echo $se['nama_lengkap'];?>">
																	<?php echo $se['nama_lengkap'];?>
																	</option>
																	<?php
																		}
																	?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
						<select name="nama_gs" id="nama_gs" class="select2 form-control" data-live-search="true" >
																	<option value="0">Pilih Nama GS </option>
																	<?php
																		foreach($itemPengguna1 as $gs)
																		{
																	?>
																		<option value="<?php echo $gs['nama_lengkap'];?>">
																	<?php echo $gs['nama_lengkap'];?>
																	</option>
																	<?php
																		}
																	?>
