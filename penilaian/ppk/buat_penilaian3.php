...
<input type="hidden" class="form-control" id="total_a1" name="total_a1" >
										 <div class="form-group row">
                                                    ...
                                                    <div class="form-check-inline form-check col-sm-6 ">
                                                        <label for="inline-checkbox1" class="form-check-label ">
                                                            <input type="checkbox" id="ca1" onclick="myFunction()" name="inline-checkbox1" class="form-check-input" checked >Pengajuan Jadwal Pelaksanaan Pekerjaan sesuai dengan jadwal
                                                        </label>
													</div>	
											...
											<div class="col-sm-3">
												<div class="btn-group btn-group-toggle" data-toggle="buttons">
												  <label class="btn bg-olive active" id="ya1" >
													<input type="radio" name="a1" value="ya"  > Ya
												  </label>
												  <label class="btn bg-olive" id="tidak1" >
													<input type="radio" name="a1" value="tidak" > Tidak
												  </label>
												</div>

											</div>
											<div class="col-sm-1">
											  <input type="text" class="form-control" id="nilai_a1" name="nilai_a1" value="<?php echo $pen['a1'];?>">
											</div>
										  </div>
										 <div class="form-group row">	
                                                    ...
                                                    <div class="form-check-inline form-check col-sm-6 ">
                                                        <label for="inline-checkbox1" class="form-check-label">
                                                            <input type="checkbox" id="ca2" onclick="myFunction()" name="inline-checkbox1" class="form-check-input" checked>Pengajuan laporan Kajian Teknis sesuai dengan jadwal
                                                        </label>
													</div>
											...
											<div class="col-sm-1">
											  <input type="text" class="form-control" id="nilai_a2"  onkeyup="total1();" name="nilai_a2" value="<?php echo $pen['a2'];?>"  >
										 ...
										 <div class="form-group row">
											...
											<!--<label class="col-sm-6 col-form-label">Pengajuan Program Mutu sesuai dengan jadwal</label>-->
                                                    <div class="form-check-inline form-check col-sm-6 ">
                                                        <label for="inline-checkbox1" class="form-check-label">
                                                            <input type="checkbox" id="ca3" onclick="myFunction()" name="inline-checkbox1" class="form-check-input" checked>Pengajuan Program Mutu sesuai dengan jadwal
                                                        </label>
													</div>
											...
											<div class="col-sm-1">
											  <input type="text" class="form-control" id="nilai_a3" alt="" name="nilai_a3" value="<?php echo $pen['a3'];?>"  >
											</div>
										  </div>
										 ...
										 <div class="form-group row">
											...
											<!--<label class="col-sm-6 col-form-label">Pelaksanaan Mobilisasi sesuai dengan jadwal</label>-->
                                                    ...
                                                    <div class="form-check-inline form-check col-sm-6 ">
                                                        <label for="inline-checkbox1" class="form-check-label">
                                                            <input type="checkbox" id="ca4" onclick="myFunction()" name="inline-checkbox1" class="form-check-input" checked>Pelaksanaan Mobilisasi sesuai dengan jadwal
                                                        </label>
													</div>
										   ...
										   <div class="col-sm-1">
											  <input type="text" class="form-control" id="nilai_a4" alt="" name="nilai_a4" value="<?php echo $pen['a4'];?>" >
											</div>
										  </div>
										  <!--
											<div class="col-sm-3">
