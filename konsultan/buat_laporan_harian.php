							...
							<div class="row">
								...
								<table class="table table-bordered table-hover" id="invoiceItem">	
									...
									<tr>
										...
										<td><input type="text" name="no_pekerjaan[]" id="no_pekerjaan_1" class="form-control" autocomplete="off"></td>
										<td><input type="text" name="jenis_pekerjaan[]" id="jenis_pekerjaan_1" class="form-control" autocomplete="off"></td>
