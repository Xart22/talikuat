...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<form action="../fungsi/edit/edit.php?konsultan1=edit" method="POST" enctype="multipart/form-data" > 
     ...
     <div class="card card-danger">
			...
			<div class="card-body">			
			     ...
			     <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Sketsa/SoftDrawing Penyedia Jasa</label>
                    <div class="col-sm-10">
     ...
     <div class="card card-primary">
			...
			<div class="card-body">	
			     ...
			     <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Upload Cheklist</label>
                    <div class="col-sm-10">
                      <input type="file" class="form-control" id="ceklist" name="ceklist" required="required">
                    </div>
                  </div>
