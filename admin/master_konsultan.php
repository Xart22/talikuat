      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Daftar Konsultan </h3>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $isi['se']; ?></td>
                      <td><?php echo $isi['ie']; ?></td>
                      <td>

                        <a href="edit_konsultan.php?konsultan=<?php echo $isi['id']; ?>"><button class="btn btn-warning">Edit</button></a>
                        <a href="../fungsi/hapus/hapus.php?konsultan=<?php echo $isi['id']; ?>"> <button type="submit" class="btn btn-danger" onclick="hpsData();">Hapus</button></a>
                      </td>
                    </tr>
                  <?php $no++;
                  } ?>
          ...
          <div class="modal-body">
            ...
            <form action="../fungsi/tambah/tambah.php?konsultan=tambah" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="nama_direktur" name="nama_direktur" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="se" name="se" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="ie" name="ie" required="required">
                </div>
              </div>
