          ...
          <div class="row">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Laporan Harian Pekerjaan </h3>
                ...
                <div class="col-lg-12 main-chart">
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="example2">
                      ...
                      <tbody>
                        <?php
                        $hasil = mysqli_query($konek, "SELECT *,detail_jadual.volume AS volren, detail_laporan_harian_pekerjaan.volume AS volreal,
                                                                              detail_jadual.tgl AS tgljadual, detail_laporan_harian_pekerjaan.tgl AS tglpekerjaan,
                                                                              detail_jadual.satuan,
                                                                              jadual.kegiatan
                                                                              FROM detail_laporan_harian_pekerjaan 
                                                                              INNER JOIN detail_jadual 
                                                                              ON detail_laporan_harian_pekerjaan.no_trans = detail_jadual.id
                                                                              INNER JOIN jadual
                                                                              ON detail_jadual.id_jadual = jadual.id");
                        $no = 1;
                        foreach ($hasil as $isi) {
                        ?>
                          <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php if ($isi['tgljadual'] != '0000-00-00') {
                                  echo date('j F Y', strtotime($isi['tgljadual']));
                                } else {
                                  echo "Tanggal Kosong";
                                } ?></td>
                            <td><?php if ($isi['tglpekerjaan'] != '0000-00-00') {
                                  echo date('j F Y', strtotime($isi['tglpekerjaan']));
                                } else {
                                  echo "Tanggal Kosong";
                                } ?></td>
                            <td><?= $isi['kegiatan']; ?></td>
                            <td><?= $isi['jenis_pekerjaan']; ?></td>
                            <td><?= $isi['sta_awal']; ?></td>
                            <td><?= $isi['sta_akhir']; ?></td>
                            <td><?= $isi['ki_ka']; ?></td>
                            <td><?= $isi['volren']; ?></td>
                            ...
                            <td><?= $isi['ket']; ?></td>
                            <td>
                              <a href="print_lap_pekerjaan.php?lap_id=<?php echo $isi['id_jadual']; ?>" data-toggle="tooltip" title="Print Laporan" target="_blank"><span class="fas fa-print">&nbsp;</span></a>
                            </td>
                          </tr>
                        <?php $no++;
                        } ?>
