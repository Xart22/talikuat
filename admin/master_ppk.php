      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Daftar PPK </h3>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="edit_ppk.php?ppk=<?php echo $isi['id']; ?>"><button class="btn btn-warning">Edit</button></a>
                        <a href="../fungsi/hapus/hapus.php?ppk=<?php echo $isi['id']; ?>"> <button type="submit" class="btn btn-danger" onclick="hpsData();">Hapus</button></a>
                      </td>
                    </tr>
                  <?php $no++;
                  } ?>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="../fungsi/tambah/tambah.php?ppk=tambah" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" readonly="readonly" class="form-control" id="tgl" name="tgl" value="<?php echo  date("j F Y"); ?>" required>
                </div>
              </div>
