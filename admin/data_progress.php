                    ...
                    ?>
                      <tr>
                        ...
                        <td width=15% align="center">
                          <a href="print_progress.php?lap_id=<?php echo $isi['id']; ?>&kegiatan=<?php echo $isi['kegiatan']; ?>&id_pek=<?php echo $isi['nmp']; ?>" title="Print Laporan" target="_blank"><span class="fas fa-print">&nbsp;</span></a>
