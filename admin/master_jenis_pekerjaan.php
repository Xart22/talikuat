          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Daftar jenis Pekerjaan</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Daftar Jenis Pekerjaan </h3>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="edit_jenis_pekerjaan.php?pekerjaan=<?php echo $isi['id']; ?>"><button class="btn btn-warning">Edit</button></a>
                        <a href="../fungsi/hapus/hapus.php?pekerjaan=<?php echo $isi['id']; ?>"> <button type="submit" class="btn btn-danger" onclick="hpsData();">Hapus</button></a>
                      </td>
                    </tr>
                  <?php $no++;
                  } ?>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form action="../fungsi/tambah/tambah.php?pekerjaan=tambah" method="post">
