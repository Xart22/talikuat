						...
						<select name="unor" id="unor" class="form-control select2" style="width:100%;" data-live-search="true" >
							<option value="0">Pilih Unor</option>
								...
								foreach($itemUnor as $ur) {
									if($data['unor'] == $ur['id_kantor']) {
								?>
									<option value="<?php echo $ur['nama_lengkap'];?>" selected>
							...
							<table class="order-list table table-responsive table-striped table-hover table-bordered" id="ruas_koordinat">
								...
								<tbody>
									<tr>
										...
										<td><input type="text" value="<?php echo $ruas["lat_awal"]; ?>" name="lat_awal[]" id="edlat_awal" class="form-control" autocomplete="off"></td>
										<td><input type="text" value="<?php echo $ruas["long_awal"]; ?>" name="long_awal[]" id="edlong_awal" class="form-control" autocomplete="off"></td>
										<td><input type="text" value="<?php echo $ruas["lat_akhir"]; ?>" name="lat_akhir[]" id="edlat_akhir" class="form-control" autocomplete="off"></td>
										<td><input type="text" value="<?php echo $ruas["long_akhir"]; ?>" name="long_akhir[]" id="edlong_akhir" class="form-control" autocomplete="off"></td>
										<td><a href="#" id="ed_cek_lok" class="badge badge-sm badge-primary check">Cek Lokasi</a></td>
...
<script>
	$("#ed_cek_lok").click(function() {
		var latawal = $("#edlat_awal").val();
		var longawal = $("#edlong_awal").val();
		var latakhir = $("#edlat_akhir").val();
		var longakhir = $("#edlong_akhir").val();
		...
		// alert(newUrl);
		var popupwin = window.open(newUrl, '_blank');
		popupwin.focus();
		window.open("https://www.google.com/maps?q="+ latawal + "," + longawal + "&ll=" + latakhir + "," + longakhir + "&z=16", "_blank");
	})
</script>
<!-- page script -->
<script>
