...
if (!empty($_POST['panjang']) && $_POST['panjang'] && !empty($_POST['schId']) && $_POST['schId']) {
  $talikuat->updateSchedule($_POST);
}

if (!empty($_GET['jd_id']) && $_GET['jd_id']) {
  echo $_GET['jd_id'];
  $data = $talikuat->get_jadual($_GET['jd_id']);
  $data_detail = $talikuat->get_jadualdetail($_GET['jd_id']);
}
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="jadual.php">Data Jadual</a></li>
                <li class="breadcrumb-item active">Edit Jadual</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
      ...
      <section class="content">
        ...
        <form action="" id="invoice-form" method="post" class="form-horizontal" role="form" novalidate="" enctype="multipart/form-data">
          ...
          <div class="card card-danger">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="kegiatan" name="kegiatan" value="<?php echo $data['kegiatan']; ?>" required="required">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Ruas Jalan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="ruas_jalan" name="ruas_jalan" value="<?php echo $data['ruas_jalan']; ?>" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="nama_penyedia" name="nama_penyedia" value="<?php echo $data['nama_penyedia']; ?>" required="required">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Nama Konsultan Supervisi</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="konsultan" name="konsultan" value="<?php echo $data['konsultan']; ?>" required="required">
                </div>
              </div>
              <div class="form-group row">
                <label class="col-sm-2 col-form-label">Unor</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="unor" name="unor" value="<?php echo $data['nama_kantor']; ?>" required="required">
                </div>
              </div>
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                ?>
						...
						-->
                  <select id="nmp" class="select2 form-control" data-live-search="true">
                    <option value="0">Pilih No Mata Pembayaran Terlebih Dahulu</option>
                    <?php
                    foreach ($itemList as $list) {
                      if ($data['nmp'] == $list['id']) {
                    ?>
                        <option value="'<?php echo $list['jenis_pekerjaan']; ?>','<?php echo $list['id']; ?>','<?php echo $list['satuan']; ?>'" selected>
                          '<?php echo $list['jenis_pekerjaan']; ?>' -' <?php echo $list['id']; ?>' - '<?php echo $list['satuan']; ?>'
                        </option>
                      <?php
                      } else { 
                      ?>
                        <option value="'<?php echo $list['jenis_pekerjaan']; ?>','<?php echo $list['id']; ?>','<?php echo $list['satuan']; ?>'">
                          '<?php echo $list['jenis_pekerjaan']; ?>' -' <?php echo $list['id']; ?>' - '<?php echo $list['satuan']; ?>'
                        </option>
                    <?php
                      }
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $data['harga_satuan']; ?>" id="harga_satuan1" alt="" name="harga_satuan1" onkeyup="total();" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $data['volume']; ?>" alt="" id="volume1" name="volume1" onkeyup="total();" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $data['satuan']; ?>" alt="" id="satuan1" name="satuan1" onkeyup="total();" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $data['nilai_kontrak']; ?>" id="nilai_kontrak" name="nilai_kontrak" value="<?php echo $data['nilai_kontrak']; ?>" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $data['jumlah_harga']; ?>" alt="" id="jumlah_harga1" name="jumlah_harga1" required="required">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" value="<?php echo $data['bobot']; ?>" alt="" id="bobot1" name="bobot1" required="required">
                </div>
              </div>
          ...
          <div class="card card-secondary">
            ...
            <div class="card-body">
              <table class="order-list table table-responsive table-striped table-hover table-bordered" id="detail_jadual">
                ...
                <?php
                $count = 0;
                foreach ($data_detail as $jadual_details) {
                  $count++;
                ?>
                  <tbody>

                    <td><input type="date" value="<?php echo $jadual_details["tgl"]; ?>" name="tgl[]" id="tgl" class="form-control" autocomplete="off"></td>
                    <td><input type="text" value="<?php echo $jadual_details["nmp"]; ?>" name="nmp[]" id="nmp" class="form-control" autocomplete="off"></td>
                    <td><input type="text" value="<?php echo $jadual_details["uraian"]; ?>" name="uraian[]" id="uraian" class="form-control" autocomplete="off"></td>
                    <td><input type="text" value="<?php echo $jadual_details["satuan"]; ?>" name="satuan[]" id="satuan" class="form-control" autocomplete="off"></td>
                    <td><input type="text" value="<?php echo $jadual_details["harga_satuan"]; ?>" name="harga_satuan[]" id="harga_satuan" class="form-control" autocomplete="off"></td>
                    <td><input type="text" value="<?php echo $jadual_details["volume"]; ?>" name="volume[]" id="volume" class="form-control" autocomplete="off"></td>
                    <td><input type="text" value="<?php echo $jadual_details["jumlah_harga"]; ?>" name="jumlah_harga[]" id="jumlah_harga" class="form-control" autocomplete="off"></td>
                    <td><input type="number" value="<?php echo $jadual_details["bobot"]; ?>" name="bobot[]" id="bobot" class="form-control" autocomplete="off"></td>
                    <td><input type="number" value="<?php echo $jadual_details["koefisien"]; ?>" name="koefisien[]" id="koefisien" class="form-control" autocomplete="off"></td>
                    <td><input type="number" value="<?php echo $jadual_details["nilai"]; ?>" name="nilai[]" id="nilai" class="form-control" autocomplete="off"></td>
                    <td><a class="deleteRow btn btn-danger btn-xs"> <span class="fas fa-times"></span> </a></td>
          ...
          <div class="card-footer">
            ...
            <input type="hidden" value="<?php echo $data['id']; ?>" class="form-control" name="schId" id="schId">
            <input type="hidden" value="<?php echo $data['nmp']; ?>" class="form-control" name="nmp1" id="nmp1">
