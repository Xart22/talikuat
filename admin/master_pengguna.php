          ...
          <div class="modal-body">
            ...
            <form action="../fungsi/tambah/tambah.php?data_user=tambah" method="post">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="nm_member" name="nm_member" required="required" placeholder="Username">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" required="required" placeholder="Nama Lengkap">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <select id="akses" name="akses" class="select2 form-control" data-live-search="true">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="alamat_member" name="alamat_member" required="required" placeholder="Alamat">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="telp" name="telp" required="required" placeholder="No .telp">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="email" class="form-control" id="email" name="email" required="required" placeholder="example@mail.com">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="nik" name="nik" required="required" placeholder="320xxxxxxxxxx">
                </div>
              </div>
