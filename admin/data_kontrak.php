              ...
              <table class="table table-bordered table-striped" id="example1">
                <thead>
                  <tr style="background:#DFF0D8;color:#333;">
                    ...
                    <th>No Kontrak</th>
                    <th style="text-align: center;">Surat Perjanjian<br />
                      SPL<br />
                      SPMK<br />
                      SPPBJ<br />
                      DKH</th>
                    <th style="text-align: center;">
                      Syarat2 Khusus Kontrak<br />
                  ...
                  ?>
                    <tr>
                      ...
                      <td><a href="../ViewerJS/#../lampiran/umum/<?php echo $isi['pk']; ?>" alt="#" style="width:200px;border:4px solid #ddd;" target="_blank">perjanjian Kontrak</a><br />
                        ...
                        <a href="../ViewerJS/#../lampiran/umum/<?php echo $isi['rab']; ?>" alt="#" style="width:200px;border:4px solid #ddd;" target="_blank">dkh</a>
                      </td>
                      <td><a href="../ViewerJS/#../lampiran/umum/<?php echo $isi['sk']; ?>" alt="#" style="width:200px;border:4px solid #ddd;" target="_blank">Syarat2 Khusus</a><br />
                        ...
                        <a href="../ViewerJS/#../lampiran/umum/<?php echo $isi['ul_jadual']; ?>" alt="#" style="width:200px;border:4px solid #ddd;" target="_blank">jadual</a>
                      </td>
                      <td><a href="../ViewerJS/#../lampiran/umum/<?php echo $isi['ul_jaminan']; ?>" alt="#" style="width:200px;border:4px solid #ddd;" target="_blank">jaminan2</a><br />
                        ...
                        <a href="../ViewerJS/#../lampiran/umum/<?php echo $isi['ul_rencana']; ?>" alt="#" style="width:200px;border:4px solid #ddd;" target="_blank">gbr Rencana</a>
                      </td>
                    </tr>
                  <?php $no++;
                  } ?>
