              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  <div class="text-center">
                    <img class="profile-user-img img-fluid img-circle" src="../assets/img/user/<?php echo $tam['gambar']; ?>" alt="#">
                  </div>

                  <h3 class="profile-username text-center"><?php echo $tam['nama_lengkap']; ?></h3>

                  <p class="text-muted text-center"><?php echo $tam['jabatan']; ?></p>

                  <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item">
                      <b>E-mail</b> <a class="float-right"><?php echo $tam['email']; ?></a>
                    </li>
                    <li class="list-group-item">
                      <b>Telp</b> <a class="float-right"><?php echo $tam['telp']; ?></a>
                    </li>
                    <li class="list-group-item">
                      <form method="POST" action="../fungsi/edit/edit.php?gambar_admin=user" enctype="multipart/form-data">
                        <input type="file" accept="image/*" name="foto">
                        <input type="hidden" value="<?php echo $tam['gambar']; ?>" name="foto2">
                        <input type="hidden" name="id" value="<?php echo $tam['id_member']; ?>">
                        <span class="pull-right">
                          <button type="submit" class="btn btn-primary btn-block" value="Tambah"><i class="fa fa-pencil"> Ganti Foto</i></button>
              ...
              <div class="card">
                <div class="card-header p-2">
                  <ul class="nav nav-pills">
                    <li class="nav-item"><a class="nav-link active" href="#kelola" data-toggle="tab">Kelola Pengguna</a></li>
                    <li class="nav-item"><a class="nav-link" href="#pass" data-toggle="tab">Ganti Password</a></li>
                  </ul>
                </div><!-- /.card-header -->
                <div class="card-body">
                  <div class="tab-content">
                    <div class="active tab-pane" id="kelola">
                      <form class="form-horizontal" method="post" action="../fungsi/edit/edit.php?profil_admin=edit">
                        <div class="form-group row">
                          <label for="inputName" class="col-sm-2 col-form-label">Nama Lengkap </label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $tam['nama_lengkap']; ?>" placeholder="nama">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputEmail" class="col-sm-2 col-form-label">Email</label>
                          <div class="col-sm-10">
                            <input type="email" class="form-control" id="email" name="email" value="<?php echo $tam['email']; ?>" placeholder="Email">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputName2" class="col-sm-2 col-form-label">Telp/Hp</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="telp" name="telp" value="<?php echo $tam['telp']; ?>" placeholder="Telp/Hp">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputSkills" class="col-sm-2 col-form-label">NIP/NIK (KTP)</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="nik" name="nik" value="<?php echo $tam['nik']; ?>" placeholder="NIP / KTP">
                          </div>
                        </div>
                        <div class="form-group row">
                          <label for="inputExperience" class="col-sm-2 col-form-label">Alamat</label>
                          <div class="col-sm-10">
                            <textarea class="form-control" id="alamat" name="alamat" placeholder="Alamat"><?php echo $tam['alamat_member']; ?></textarea>
                          </div>
                        </div>

                        <div class="form-group row">
                          <div class="offset-sm-2 col-sm-10">
                            <input type="hidden" name="id" id="id" value="<?php echo $tam['id_member']; ?>">
                    ...
                    <div class="tab-pane" id="pass">
                      <form class="form-horizontal" method="POST" action="../fungsi/edit/edit.php?pass_admin=ganti-pas">
                        <div class="form-group row">
                          <label for="inputName" class="col-sm-2 col-form-label">Username</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="user1" value="<?php echo $tam['user']; ?>" placeholder="Name" readonly="readonly">
                            <input type="hidden" class="form-control" id="user" name="user" value="<?php echo $tam['user']; ?>">
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          <div class="offset-sm-2 col-sm-10">
                            <input type="hidden" class="form-control" style="border-radius:0px;" name="id" id="id" value="<?php echo $tam['id_member']; ?>" />
                            <button type="submit" class="btn btn-danger">Submit</button>
                          </div>
                        </div>
                      </form>
