...
$sql = mysqli_query($konek, "SELECT *,COUNT(tanggal) as jmlabsen, GROUP_CONCAT(tanggal ORDER BY tanggal ASC) as hari FROM absen WHERE nik = " . $nik);
...
$output = "
        <h4 style='text-align:center;'><b>DETAIL ABSENSI BULANAN <br> KONSULTAN PENGAWAS FIELD TEAM</b></h4>
";
