...
// $pak = mysqli_query($konek, "SELECT kegiatan, sum(jadual.volume + detail_laporan_harian_pekerjaan.volume) as persen FROM detail_laporan_harian_pekerjaan JOIN jadual ON detail_laporan_harian_pekerjaan.id_kegiatan = jadual.id GROUP BY kegiatan");
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Penilaian Kinerja Penyedia Pelaksana Konstruksi </h3>
                        </div>
                        <div class="card-body">
                            <div class="col-lg-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped text-center" id="example1">
                                        ...
                                        <tbody>
                                            <?php
                                            $pkinerja = $talikuat->get_penilaian();
                                            $no = 1;
                                            foreach ($pkinerja as $data) {
                                            ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    ...
                                                    <td>
                                                        <a href="print_penilaian.php?id=<?= $data['id'] ?>" class="btn btn-danger btn-sm" target="_blank">
