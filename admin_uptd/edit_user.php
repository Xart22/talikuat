              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="../assets/img/user/<?php echo $tam['gambar'];?>"
                       alt="#">
                </div>
                ...
                <ul class="list-group list-group-unbordered mb-3">
				  ...
				  <li class="list-group-item">
										<form method="POST" action="../fungsi/edit/edit.php?gambar_admin_uptd=user" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="kelola">
                    <form class="form-horizontal" method="post" action="../fungsi/edit/edit.php?profil_admin_uptd=edit" >
                  ...
                  <div class="tab-pane" id="pass">
                    <form class="form-horizontal" method="POST" action="../fungsi/edit/edit.php?pass_admin_uptd=ganti-pas">
                      <div class="form-group row">
