            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
				  ...
				  <li class="list-group-item">
										<form method="POST" action="../fungsi/edit/edit.php?gambar_kontraktor=user" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="kelola">
                    <form class="form-horizontal" method="post" action="../fungsi/edit/edit.php?profil_kontraktor=edit" >
                  ...
                  <div class="tab-pane" id="pass">
                    <form class="form-horizontal" method="POST" action="../fungsi/edit/edit.php?pass_kontraktor=ganti-pas">
                      <div class="form-group row">
