        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		 ...
		 <li class="nav-item has-treeview <?php if ($menu == "Kontraktor" || $menu == "Edit Kontraktor" || $menu == "Konsultan" || $menu == "Edit Konsultan" || $menu == "PPK" || $menu == "Edit PPK" || $menu == "Jenis Pekerjaan" || $menu == "Edit Jenis Pekerjaan" || $menu == "Pengguna" || $menu == "Edit Pengguna") {
            ...
            <ul class="nav nav-treeview">
              ...
              <!-- <li class="nav-item">
                <a href="buat_penilaian.php" class="nav-link <?php if ($menu == "Buat Penilaian Penyedia") {
                                                                                echo "active";
                                                                            } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Buat Penilaian Penyedia</p>
                </a>
              </li>		  			   -->
            </ul>
          </li>
		 ...
		 <li class="nav-item has-treeview <?php if ($menu == "Edit User") {
                                                        echo "menu-open";
                                                    } ?>">
            <a href="#" class="nav-link <?php if ($menu == "Edit User") {
                                                        echo "active";
                                                    } ?>">
