...
if(!empty($_GET['konsultan']) && $_GET['konsultan']) {
	echo $_GET['konsultan'];
	$data = $tampil->konsultan_edit($_GET['konsultan']);		
}
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
			  ...
			  <li class="breadcrumb-item"><a href="master_konsultan.php">Data Konsultan</a></li>
	...
	<form action="../fungsi/edit/edit.php?konsultan2=tambah" method="post">
     ...
     <div class="card card-danger">
			...
			<div class="card-body">
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $data['nama']; ?>" required="required" >
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nama_direktur" name="nama_direktur" value="<?php echo $data['nama_direktur']; ?>" required="required" >
                    </div>
                  </div>

			     <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Nama Site Engineering</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="se" name="se" value="<?php echo $data['se']; ?>"required="required" >
                    </div>
                  </div>

			     <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Nama Inspection Engineering</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="ie" name="ie" value="<?php echo $data['ie']; ?>" required="required" >
                    </div>
                  </div>
