...
if(!empty($_POST['panjang']) && $_POST['panjang']) {	
	$talikuat->saveJadual_kontraktor($_POST);
}
...
<style>#detail_jadual{display:none;}</style>
     ...
     <div class="card card-danger">
			...
			<div class="card-body">
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="waktu" name="waktu" value="<?php echo $data['waktu_pelaksanaan'];?> Hari" required="required">
					</div>
                  </div>				  
			     <div class="form-group row">
