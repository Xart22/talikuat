...
if(!empty($_POST['jenis_pekerjaan']) && $_POST['jenis_pekerjaan']) {	
	$talikuat->saveRequest($_POST);
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Buat Request Pekerjaan</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
     ...
     <div class="card card-danger">
			...
			<div class="card-body">			
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="diajukan_tgl" name="diajukan_tgl" required="required">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="lokasi_sta" name="lokasi_sta" placeholder="Km.Bdg......s/d ....." required="required">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="jenis_pekerjaan" name="jenis_pekerjaan" value="<?php echo $data['nmp'];?>" required="required">
					  <input type="hidden" class="form-control" id="jp" name="jp" value="<?php echo $data['jenis_pekerjaan'];?>">
                    </div>
                  </div>
				 ...
				 <div class="form-group row">
                    ...
                    <div class="col-sm-10">   
						<div class="input-group mb-3">
						    <input type="text" class="form-control" id="perkiraan_volume" name="perkiraan_volume" value="<?php echo $data['volume'];?>" required="required">
							<input id="satuan" value="<?php echo $data['satuan'];?>" type="hidden" class="form-control" name="satuan">
						  <div class="input-group-append">
						  
							<span class="input-group-text"><?php echo $data['satuan'];?></span>
						  </div>
						</div>
					</div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="pelaksanaan_tgl" name="pelaksanaan_tgl" required="required">
                    </div>
                  </div>				  
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="file" class="form-control" id="sketsa" name="sketsa" required="required">
                    </div>
                  </div>				  
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<table class="table table-bordered table-hover" id="invoiceItem1">	
										...
										<tr>
											...
											<td><input type="text" name="volume_bahan[]" id="volume_bahan_1" class="form-control" autocomplete="off"></td>
			...
			<div class="card-body">
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
																<select name="penyedia_jasa" id="penyedia_jasa" class="select2 form-control" data-live-search="true" >
																	<option value="<?php echo $data['nama_penyedia'];?>"><?php echo $data['nama_penyedia'];?></option>
																	<?php
			    ...
			    <div class="form-group row">
                    ...
                    <div class="col-sm-10">
																<select name="konsultan" id="konsultan" class="select2 form-control" data-live-search="true" >
																	<option value="<?php echo $data['konsultan'];?>"><?php echo $data['konsultan'];?></option>
																	<?php
			    ...
			    <div class="form-group row">
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="ci" alt="" name="ci" required="required">
					</div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="qe" alt="" name="qe" required="required">
					</div>
                  </div>
