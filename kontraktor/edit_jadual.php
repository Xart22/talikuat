     ...
     <div class="card card-danger">
			...
			<div class="card-body">
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="unor" name="unor" value="<?php echo $data['unor'];?>" required="required">
					</div>
                  </div>
			...
			<div class="card-body">
		         ...
		         <div class="form-group row">
					...
					<select id="nmp" class="select2 form-control" data-live-search="true" >
						<option value="<?php echo $data['nmp'];?>"><?php echo $data['nmp'];?></option>
						<?php
							foreach($itemList as $list)
							{
						?>								
