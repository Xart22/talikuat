...
if(!empty($_GET['kontraktor']) && $_GET['kontraktor']) {
	echo $_GET['kontraktor'];
	$data = $tampil->kontraktor_edit($_GET['kontraktor']);		
}

include "../src/LogHistory.php";
$log = new LogHistory();
$menu = "Edit Kontraktor";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
			  ...
			  <li class="breadcrumb-item"><a href="master_kontraktor.php">Data Penyedia Jasa</a></li>
              <li class="breadcrumb-item active">Edit Data Penyedia Jasa</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
	...
	<form action="../fungsi/edit/edit.php?kontraktor=tambah" method="post">
     ...
     <div class="card card-danger">
			...
			<div class="card-body">
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $data['nama']; ?>" required="required" placeholder="Nama">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $data['alamat']; ?>" required="required" placeholder="Alamat Kantor">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="nama_direktur" name="nama_direktur" value="<?php echo $data['nama_direktur']; ?>" required="required" placeholder="Nama Direktur">
                    </div>
                  </div>				  
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="npwp" name="npwp" value="<?php echo $data['npwp']; ?>" required="required" placeholder="No NPWP">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="telp" name="telp" value="<?php echo $data['telp']; ?>" required="required" placeholder="No Telp / HP">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="bank" name="bank" value="<?php echo $data['bank']; ?>" required="required" placeholder="Bank/Cabang">
                    </div>
                  </div>
			     ...
			     <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" id="no_rek" name="no_rek" value="<?php echo $data['no_rek']; ?>" required="required" placeholder="Nomor Rekening">
                    </div>
                  </div>
