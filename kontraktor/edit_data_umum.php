...
if(!empty($_POST['nama_kegiatan']) && $_POST['nama_kegiatan'] && !empty($_POST['data_umum']) && $_POST['data_umum']) {	
	$talikuat->updateDataUmum_kontraktor($_POST);	
					...
					<div class="card-header">
					  ...
					  <div class="card-tools">
						...
						<div class="card-body">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?rab1_kontraktor=user" enctype="multipart/form-data">
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?rab2_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?rab3_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?pk_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?sm_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?sk_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?ul_spmk_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?ul_jadual_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?ul_rencana_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?ul_sppbj_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?ul_spl_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?ul_spek_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?ul_jaminan_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
							...
							<div>
									<form method="POST" class="form-horizontal" action="../fungsi/edit/edit.php?ul_spkmp_kontraktor=user" enctype="multipart/form-data">
										<div class="form-group">	
