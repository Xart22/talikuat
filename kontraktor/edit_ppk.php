...
if(!empty($_GET['ppk']) && $_GET['ppk']) {
	echo $_GET['ppk'];
	$data = $tampil->ppk_edit($_GET['ppk']);		
}
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
			  ...
			  <li class="breadcrumb-item"><a href="master_ppk.php">Data PPK</a></li>
              <li class="breadcrumb-item active">Edit Data PPK</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
	...
	<form action="../fungsi/edit/edit.php?ppk2=tambah" method="post">
     ...
     <div class="card card-danger">
			...
			<div class="card-body">
			     ...
			     <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Nama PPK</label>
                    <div class="col-sm-8">
