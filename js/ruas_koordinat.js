$(document).ready(function ()
	{
		...
		{
			var selectValue = $('#ruas_jalan').val();
			var selectText = $("#ruas_jalan option:selected").text();
			...
			if(selectValue != 0)
			{
				...
				cols += '<td>'+
						...
						'</td>';	
				cols += '<td>'+
							'<a href="#" id="cek_lok" class="badge badge-sm badge-primary">Cek Lokasi</a>'+
						'</td>';
				cols += '<td>'+
				...
				$("#cek_lok").click(function() {
					var latawal = $("#lat_awal").val();
					var longawal = $("#long_awal").val();
					var latakhir = $("#lat_akhir").val();
					var longakhir = $("#long_akhir").val();
				...
				alert('Pilih Dulu Ruas Jalannya Kang');
		});
